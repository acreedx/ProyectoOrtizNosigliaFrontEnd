    ...
    <main>
      <section className="we-do-section pt-150">
        <div className="shape shape-1">
          <Image
            src="/paginawebimages/shapes/shape-1.svg"
            alt=""
            width={400}
            height={400}
          />
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="graph mb-60">
                <Image
                  src="/paginawebimages/we-do/graph-img.svg"
                  alt=""
                  width={1000}
                  height={1000}
                />
      ...
      <section id="about" className="about-section pt-120">
        <div className="shape shape-2">
          <Image
            src="/paginawebimages/shapes/shape-2.svg"
            alt=""
            width={400}
            height={400}
          />
        ...
        <div className="about-img text-center">
          <Image
            src="/paginawebimages/about/about-img.png"
            alt=""
            width={400}
            height={400}
          />
      ...
      <section id="services" className="service-section pt-150">
        <div className="shape shape-3">
          <Image
            src="/paginawebimages/shapes/shape-3.svg"
            alt=""
            width={400}
            height={400}
          />
      ...
      <section id="testimonial" className="team-section pb-150 pt-150">
        ...
        <div className="shape shape-6">
          <Image
            src="/paginawebimages/shapes/shape-5.svg"
            alt=""
            width={400}
            height={400}
          />
      ...
      <section className="faq-section theme-bg">
        <div className="faq-video-wrapper">
          <div className="faq-video">
            <Image
              src="/paginawebimages/faq/faq-img.jpg"
              alt=""
              width={400}
              height={400}
            />
        ...
        <div className="shape">
          <Image
            src="/paginawebimages/shapes/shape-8.svg"
            alt=""
            width={400}
            height={400}
            className="shape-faq"
            ...
            <div className="col-xl-6 offset-xl-6 col-lg-8 col-md-10">
              <div className="faq-content-wrapper pb-90 pt-90">
                <div className="section-title">
                  <span
                    className="wow fadeInDown text-white"
                    data-wow-delay=".2s"
                  >
      ...
      <section id="blog" className="blog-section pt-150">
        <div className="shape shape-7">
          <Image
            src="/paginawebimages/shapes/shape-6.svg"
            alt=""
            width={400}
            height={400}
          />
            ...
            <div className="col-xl-4 col-lg-4 col-md-6">
              ...
              >
                <div className="blog-img">
                  <a href="#">
                    <Image
                      src="/paginawebimages/blog/blog-1.png"
                      alt=""
                      width={400}
                      height={400}
                    />
            ...
            <div className="col-xl-4 col-lg-4 col-md-6">
              ...
              >
                <div className="blog-img">
                  <a href="#">
                    <Image
                      src="/paginawebimages/blog/blog-2.png"
                      alt=""
                      width={400}
                      height={400}
                    />
            ...
            <div className="col-xl-4 col-lg-4 col-md-6">
              ...
              >
                <div className="blog-img">
                  <a href="#">
                    <Image
                      src="/paginawebimages/blog/blog-3.png"
                      alt=""
                      width={400}
                      height={400}
                    />
