    ...
    <main>
      ...
      <section id="about" className="about-section pt-120 bg-white">
        ...
        <div className="about-img text-center">
          <Image
            src="/images/paginaweb/about/about-img.png"
            alt=""
            width={400}
            height={400}
          />
      ...
      <section className="faq-section theme-bg">
        <div className="faq-video-wrapper">
          <div className="faq-video">
            <Image
              src="/images/paginaweb/faq/faq-img.jpg"
              alt=""
              width={400}
              height={400}
            />
            ...
            <div className="mt-[0rem] w-full max-w-full flex-shrink-0 px-[calc(1.5rem*0.5)] md:w-10/12 lg:w-2/3 xl:ml-auto xl:w-1/2">
              <div className="faq-content-wrapper pb-90 pt-90">
                <div className="section-title">
                  <span
                    className="wow fadeInDown font-raleway mb-[15px] block text-[25px] font-semibold text-white"
                    data-wow-delay=".2s"
                  >
