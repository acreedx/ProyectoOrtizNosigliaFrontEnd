...
const TableThree = () => {
  ...
  const deletePatient = async (id: string) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const url = localDomain + "person/deletepatient/" + id;
        console.log(url);
  ...
  const restorePatient = async (id: string) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const url = localDomain + "person/restorepatient/" + id;
        console.log(url);
        const response = await fetch(url);
        if (!response.ok) {
          const error = await response.json();
                    ...
                    <div className="flex items-center space-x-3.5">
                      ...
                      {!person.estado ? (
                        ...
                        >
                          ...
                          >
                            <path
                              d="M9 1.5C4.86 1.5 1.5 4.86 1.5 9C1.5 13.14 4.86 16.5 9 16.5C13.14 16.5 16.5 13.14 16.5 9H15C15 12.14 12.14 15 9 15C5.86 15 3 12.14 3 9C3 5.86 5.86 3 9 3V5.25L13.5 1.5L9 0.75V1.5Z"
                              fill=""
                            />
                            <path d="M12.75 6H9.75V8.25H12.75V6Z" fill="" />
                          </svg>
                        </button>
                      ) : (
                        <button
